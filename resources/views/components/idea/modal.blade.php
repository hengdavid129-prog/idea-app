                ...
                <fieldset class="space-y-3">
                    ...
                    <template x-for="(step, index) in steps" :key="step.id || index">
                        <div class="flex gap-x-2 items-center">
                            <input :name="`steps[${index}][description]`" x-model="step.description" class="input" readyonly>
                            <input type="hidden" :name="`step[${index}][completed]`" x-model="step.completed ? '1' : '0'" class="input">
